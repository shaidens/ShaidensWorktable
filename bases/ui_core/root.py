...
from bases.ui_core.home_uiC import home_ui
...
class Ui_MainWindow(FluentWindow):
    ...
    def setupUi(self):
        ...
        #实例化子界面
        self.home_page_sub_interface = home_ui(self)
        self.software_lib_page_sub_interface = softwareLib_ui(self)
        print(self.software_lib_page_sub_interface,type(self.software_lib_page_sub_interface),type(self.home_page_sub_interface))
        self.retranslateUi()
    ...
    def initNavigation(self):
        self.addSubInterface(interface=self.home_page_sub_interface, icon=FIF.HOME, text='Home')
        self.navigationInterface.addSeparator()

        self.addSubInterface(interface=self.software_lib_page_sub_interface, icon=FIF.APPLICATION, text='software' )
